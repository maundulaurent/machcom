        ...
        <div className="flex flex-col md:flex-row w-full max-w-5xl bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-16 flex flex-col justify-center">
            <div className="text-center mb-4">
              ...
              <p className="text-xs text-gray-500">Welcome to Machcom - Login to get Started</p>
            </div>
            <div className="flex flex-row gap-4 mb-6">
              <button className="w-full flex items-center justify-center py-1 px-3 border border-gray-300 rounded-xl text-sm font-small text-gray-700 bg-white hover:bg-gray-50">
                <FcGoogle className="h-4 w-4 mr-2" /> Log in with Google
              </button>
              <button className="w-full flex items-center justify-center py-1 px-3 border border-gray-300 rounded-xl text-sm font-small text-gray-700 bg-white hover:bg-gray-50">
                <FaFacebook className="h-4 w-4 mr-2" /> Log in with Facebook
              </button>
            </div>
            <form>
            ...
            <div className="mt-4 text-center">
              <span className="text-sm text-gray-500">Have no account? </span>
              <a href="/register" className="text-sm text-green-600 hover:underline">Sign Up</a>
            </div>
          </div>
